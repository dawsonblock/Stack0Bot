...
export const TOP_LEVEL_SUBCOMMANDS: readonly GsdCommandDefinition[] = [
  ...
  { cmd: "runtime", desc: "Gateway/runtime health, capability flags, and model visibility" },
...
const NESTED_COMPLETIONS: CompletionMap = {
  ...
  runtime: [
    { cmd: "status", desc: "Show gateway health, runtime health, and capability summary" },
    { cmd: "health", desc: "Probe the gateway and upstream runtime" },
    { cmd: "capabilities", desc: "Show capability flags reported by the gateway" },
    { cmd: "models", desc: "List models exposed through the runtime" },
  ],
  doctor: [
