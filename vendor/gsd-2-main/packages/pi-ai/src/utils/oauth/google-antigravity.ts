...
const CLIENT_ID = process.env.GSD_GOOGLE_ANTIGRAVITY_CLIENT_ID?.trim() || "unset-google-antigravity-client-id";
const CLIENT_SECRET = process.env.GSD_GOOGLE_ANTIGRAVITY_CLIENT_SECRET?.trim() || "unset-google-antigravity-client-secret";
