...
const CLIENT_ID = process.env.GSD_GOOGLE_GEMINI_CLIENT_ID?.trim() || "unset-google-gemini-client-id";
const CLIENT_SECRET = process.env.GSD_GOOGLE_GEMINI_CLIENT_SECRET?.trim() || "unset-google-gemini-client-secret";
